  ...
  return (
    <div className="container-fluid text-white p-5" id="body" style={{ backgroundColor: 'black', height: '100vh' }}>
      <div className="row mt-5">
        ...
        <div className="col-md-5 position-relative d-flex justify-content-start align-items-start rounded-lg">
          <img
            src="image/hero1.jpg"
            alt="Illustration"
            className="img-fluid position-absolute moving-image hide-on-mobile"
            style={{ maxWidth: '60%', right: '80%', bottom: '-4%', transform: 'rotate(-15deg)', borderRadius: '20px' }}
          />
          <img
            src="image/hero2.jpg"
            alt="Sticker"
            className="img-fluid position-absolute moving-image hide-on-mobile"
            style={{ maxWidth: '45%', right: '28%', bottom: '-54%', height:"300px", transform: 'rotate(18deg)', borderRadius: '20px' }}
          />
        </div>
